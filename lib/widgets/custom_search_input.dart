  ...
  Widget build(BuildContext context) {
    InputBorder inputBorder = new OutlineInputBorder(
      borderSide: BorderSide(
          style: BorderStyle.none, width: 0, color: Colors.white),
      ...
      Padding(
          ...
          child: TextField(
            decoration: new InputDecoration(
              ...
              prefixIcon: Icon(
                loyaltySearchInput.icon, color: Colors.grey[400],),
              border: inputBorder,
              focusedBorder: inputBorder.copyWith(borderSide: BorderSide(width: 1,color: Colors.white)),
